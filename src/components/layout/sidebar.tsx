...
import {
  ...
  Sparkles, Calendar, Gift, Palmtree, Network,
} from "lucide-react";
...
const instituteNav: NavItem[] = [
  ...
  { label: "Leadership", href: "/institute/management", icon: Network },
  { label: "About Institute", href: "/institute/about", icon: Building2 },

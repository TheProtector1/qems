...
import { TeacherDailyDuasContent } from "@/components/teacher/teacher-daily-duas-content";
...
export function TeacherCharacterBuildingTabs() {
  ...
  return (
    <div className="space-y-6">
      ...
      {activeTab === "tasks" ? <TeacherCharacterBuildingContent /> : <TeacherDailyDuasContent />}
    </div>
  );
}

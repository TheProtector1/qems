...
import { ParentDailyDuasContent } from "@/components/parent/parent-daily-duas-content";
...
export function ParentCharacterBuildingTabs() {
  ...
  return (
    <div className="space-y-6">
      ...
      {activeTab === "tasks" ? <ParentCharacterBuildingContent /> : <ParentDailyDuasContent />}
    </div>
  );
}
